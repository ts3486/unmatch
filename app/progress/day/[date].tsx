      ...
      {isLoading ? (
        ...
        <>
          ...
          <View style={styles.summaryRow}>
            <SummaryBadge count={successCount} label="Resisted" color={colors.success} />
            <SummaryBadge count={failCount} label="Did not resist" color="#E05A5A" />
            <SummaryBadge count={ongoingCount} label="Ongoing" color={colors.muted} />
          </View>
                ...
                <Card.Content style={styles.checkinContent}>
                  ...
                  {checkin.opened_at_night !== null && (
                    <>
                      ...
                      <View style={styles.checkinRow}>
                        <Text variant="bodyMedium" style={styles.muted}>Opened late at night</Text>
                  ...
                  {checkin.spent_today !== null && (
                    <>
                      <Divider style={styles.divider} />
                      <View style={styles.checkinRow}>
                        <Text variant="bodyMedium" style={styles.muted}>Spent today</Text>
                        <Text variant="bodyMedium" style={styles.valueText}>
              ...
              <View style={styles.timeline}>
                {urgeEvents.map((ev, idx) => (
                  <View key={ev.id} style={styles.timelineItem}>
                    ...
                    <View style={[styles.timelineDot, { backgroundColor: outcomeColor(ev.outcome) }]} />
                    <View style={styles.timelineContent}>
                      <View style={styles.timelineHeader}>
                        ...
                        <Chip
                          ...
                          textStyle={{ color: outcomeColor(ev.outcome), fontSize: 11 }}
                        >
                      ...
                      <Text variant="bodyMedium" style={styles.timelineKind}>
                        ...
                        {ev.trigger_tag !== null && (
                          <Text style={styles.triggerTag}> · {ev.trigger_tag}</Text>
                        )}
                      </Text>
  ...
  return (
    <View style={styles.checkinRow}>
      ...
      <View style={styles.ratingDots}>
        ...
        <Text variant="bodyMedium" style={styles.valueText}>{value}/5</Text>
      </View>
    </View>
  );
}
