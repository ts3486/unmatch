...
function YesNoToggle({ label, value, onChange, readonly = false }: YesNoToggleProps): React.ReactElement {
  return (
    <View style={styles.yesNoRow}>
      ...
      <View style={styles.chipRow}>
        <Chip
          ...
          style={[
            styles.ratingChip,
            value === true && styles.yesChipSelected,
          ]}
          textStyle={[
        ...
        <Chip
          ...
          style={[
            styles.ratingChip,
            value === false && styles.noChipSelected,
          ]}
          textStyle={[
            styles.ratingChipText,
...
export default function CheckinScreen(): React.ReactElement {
  ...
  const handleSpentAmountChange = useCallback((text: string): void => {
  ...
  const spentAmountDollars = spentAmount !== null && spentAmount > 0
      ...
      >
        ...
        <Card style={styles.card} mode="contained">
          <Card.Content style={styles.summaryContent}>
            <RatingChips label="Mood" value={existingCheckin.mood} onChange={() => {}} readonly labelMap={MOOD_LABELS} />
            <Divider style={styles.divider} />
            <RatingChips label="Fatigue" value={existingCheckin.fatigue} onChange={() => {}} readonly labelMap={FATIGUE_LABELS} />
            <Divider style={styles.divider} />
            <RatingChips label="Urge level" value={existingCheckin.urge} onChange={() => {}} readonly labelMap={URGE_LABELS} />
      ...
      >
        ...
        <Card style={styles.card} mode="contained">
          <Card.Content style={styles.formContent}>
            <RatingChips label="Mood" value={mood} onChange={setMood} labelMap={MOOD_LABELS} subtitle="How are you feeling right now?" />
            <Divider style={styles.divider} />
            <RatingChips label="Fatigue" value={fatigue} onChange={setFatigue} labelMap={FATIGUE_LABELS} />
            <Divider style={styles.divider} />
            <RatingChips label="Urge level" value={urge} onChange={setUrge} labelMap={URGE_LABELS} />
          </Card.Content>
        </Card>
