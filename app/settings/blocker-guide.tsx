	...
	return (
		...
		>
			...
			<Text variant="bodyMedium" style={styles.intro}>
				Your device has built-in tools to set boundaries on app usage. These are
				optional and entirely within your control.
			</Text>

			<View style={styles.disclaimerBox}>
				<Text variant="bodySmall" style={styles.disclaimerText}>
					This app cannot block other apps directly. The steps below use your
					device's native controls.
				</Text>
			</View>
						...
						<Card.Content style={styles.stepsContent}>
							{ANDROID_STEPS.map((step, idx) => (
								<StepRow
									...
									number={idx + 1}
									text={step}
									isLast={idx === ANDROID_STEPS.length - 1}
								/>
							))}
						</Card.Content>
					</Card>
			...
			<View style={styles.tipBox}>
				...
				<Text variant="bodyMedium" style={styles.tipText}>
					Setting a limit does not remove access entirely. It creates a moment
					of pause — which is often all you need to make a mindful choice.
				</Text>
			</View>
