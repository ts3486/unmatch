...
export function ResistRankCompact({ level, resistCount }: ResistRankCompactProps): React.ReactElement {
  ...
  return (
    <Surface style={styles.card} elevation={2}>
      ...
      <Text variant="labelSmall" style={styles.progress}>
        {isMaxLevel ? 'Max' : `${resistsIntoCurrentLevel}/${RESIST_RANK_RESISTS_PER_LEVEL}`}
      </Text>
    </Surface>
  );
}
